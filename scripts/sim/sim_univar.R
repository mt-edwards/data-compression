...
# ========================
temp_model_resid = abind(aperm(replicate(as.numeric(args[6]), temp_model), c(4, 3, 1, 2)), resid, along = 2)

# Complete data.
# ========================
Y = aperm(aaply(temp_model_resid, 3:4, temp_trend_array, p.max = as.numeric(args[3]), .progress = "text"), c(4, 3, 1, 2))
