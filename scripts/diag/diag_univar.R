...
# Load data.
# =======================
load(file = paste0("data/", args[1], "/Y.r", args[2], ".p", args[3], ".q", args[4], ".t", args[5], ".s", args[6], ".R"))
...
# =======================
png(paste0("plots/", args, "/temp_lat.r5.p3.q0.t10.s5.png"), width = 900, height = 900)
...
# Spatial NetCDF File.
# ========================
map2(alply(spat_p, 1), c("intercept.r5.p3.q0.t10.s5", "trend.r5.p3.q0.t10.s5", "std.r5.p3.q0.t10.s5", "auto_cov.r5.p3.q0.t10.s5"), save_ncdf, lon = lon, lat = lat, args = args)
